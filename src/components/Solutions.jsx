    ...
    icon: function ReportingIcon() {
      ...
      return (
        <>
          <path
            opacity=".4"
            d="M7.4,10.64H28.6c.48,0,.87,.39,.87,.87h0v12.99c0,.48-.39,.87-.86,.87H7.4c-.48,0-.87-.39-.87-.87h0V11.51c0-.48,.39-.87,.86-.87h0Z"
            fill="#fff"
          />
          <path
            d="M15.4,13.25h5.19c.24,0,.43,.19,.43,.43v8.64c0,.24-.19,.43-.43,.43h-5.19c-.24,0-.43-.19-.43-.43h0V13.68c0-.24,.19-.43,.43-.43h0Z"
            fill="#fff"
          />
        </>
      )
