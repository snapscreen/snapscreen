...
import phoneMock from '@/assets/screenshots/phone.svg'
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          ...
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            ...
            boosts fan engagement and monetization.
          </p>
        </div>
        <Tab.Group
          as="div"
        ...
        >
          {({ selectedIndex }) => (
            <>
              <div className="-mx-4 flex overflow-x-auto pb-4 sm:mx-0 lg:overflow-visible lg:pb-0 lg:col-span-5">
                <Tab.List className="relative z-10 flex gap-x-4 whitespace-nowrap px-4 sm:mx-auto lg:px-0 lg:mx-0 lg:block lg:gap-x-0 lg:gap-y-1 lg:whitespace-normal">
              ...
              <Tab.Panels className="lg:col-span-7">
                {features.map((feature) => (
                  <Tab.Panel key={feature.title} unmount={false}>
                    ...
                    <div className="relative mt-10 w-[45rem] max-h-[80vh] overflow-hidden rounded-xl bg-white shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-[67.8125rem]">
                      {/*
                      <Image
                        className="w-1/3 absolute left-8 lg:left-24 top-16"
                        src={phoneMock}
                        alt=""
                        priority
                      />
